...
Performance Tips
Use compression for network drives or limited space
Use incremental for daily backups, full weekly
Install pigz for faster compression: sudo apt-get install pigz
Exclude large unnecessary directories by adding to rsync excludes
Run during off-hours to minimize system impact
Troubleshooting
